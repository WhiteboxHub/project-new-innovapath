              ...
              <div className="transition-all">
                <div className="relative flex flex-col" data-aos="fade-down">
                  ...
                  <Transition show={tab === 1}>
                    <div className="w-full transition ease-in-out data-closed:opacity-0 data-enter:duration-700 data-enter:data-closed:-translate-y-16 data-closed:absolute data-leave:duration-300 data-leave:data-closed:translate-y-16">
                      <div className="relative inline-flex flex-col">
                        <Image className="md:max-w-none mx-auto rounded-sm" src={FeaturesImage} width={540} height={620} alt="Features home 2 01" />
                      </div>
                    </div>
                  </Transition>
                  {/* Item 2 */}
                  <Transition show={tab === 2}>
                    <div className="w-full transition ease-in-out data-closed:opacity-0 data-enter:duration-700 data-enter:data-closed:-translate-y-16 data-closed:absolute data-leave:duration-300 data-leave:data-closed:translate-y-16">
                      <div className="relative inline-flex flex-col">
                        <Image className="md:max-w-none mx-auto rounded-sm" src={FeaturesImage} width={540} height={620} alt="Features home 2 02" />
                      </div>
                    </div>
                  </Transition>
                  {/* Item 3 */}
                  <Transition show={tab === 3}>
                    <div className="w-full transition ease-in-out data-closed:opacity-0 data-enter:duration-700 data-enter:data-closed:-translate-y-16 data-closed:absolute data-leave:duration-300 data-leave:data-closed:translate-y-16">
                      <div className="relative inline-flex flex-col">
                        <Image className="md:max-w-none mx-auto rounded-sm" src={FeaturesImage} width={540} height={620} alt="Features home 2 03" />
                      </div>
                    </div>
                  </Transition>
                </div>
