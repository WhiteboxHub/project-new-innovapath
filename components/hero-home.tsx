      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6">
        <div className="pt-32 pb-20 md:pt-40 md:pb-44">
          ...
          <div className="max-w-xl mx-auto md:max-w-none md:flex md:items-center md:space-x-8 lg:space-x-16 xl:space-x-20 space-y-16 md:space-y-0">
            ...
            <div className="text-center md:text-left space-y-6 max-w-xl" data-aos="fade-left">
              <p className="text-xl text-slate-400">
                Leverage Agentic AI, RAG, and Smart Chatbots to streamline talent operations, enhance decision-making,
                and scale innovation with precision and speed.
              </p>
