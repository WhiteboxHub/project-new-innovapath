...
export default function Team() {  
  ...
  <div className="text-center mb-16">
    <h2 className="text-2xl sm:text-3xl md:text-4xl font-playfair-display font-bold text-slate-800">
  ...
  <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-slate-800">
    ...
    <div className="border border-gray-300 rounded-xl p-6 h-full transition duration-300 hover:border-blue-500 hover:shadow-lg hover:shadow-blue-200">
      <h3 className="text-2xl sm:text-3xl font-playfair-display font-semibold mb-4">Our Mission</h3>
      <p className="text-base sm:text-lg text-slate-600 mb-2">
        At Innovapath, our mission is simple: make advanced AI accessible, responsible, and impactful for every organization.
      </p>
      <p className="text-base sm:text-lg text-slate-600">
        We believe that AI should not be reserved for tech giants—it should be a catalyst for transformation across industries, teams, and use cases.
      </p>
    </div>
    ...
    {/* Our Team */}
    <div className="border border-gray-300 rounded-xl p-6 h-full transition duration-300 hover:border-blue-500 hover:shadow-lg hover:shadow-blue-200">
      <h3 className="text-2xl sm:text-3xl font-playfair-display font-semibold mb-4">Our Team</h3>
      <p className="text-base sm:text-lg text-slate-600">
        Led by a team of AI researchers, engineers, and industry experts, Innovapath is committed to creating responsible, transparent AI solutions that empower decision-makers and respect users.
      </p>
    </div>
