                ...
                <form>
                  <div className="space-y-4">
                    ...
                    <div>
                      ...
                      <input id="phone" className="rounded-md form-input py-2 w-full" type="tel" required placeholder="+1 (555) 123-4567" />
                    </div>
                    ...
                    <div>
                      ...
                      <select id="country" className="rounded-md form-select py-2 w-full" required defaultValue="">
