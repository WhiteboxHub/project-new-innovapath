...
//               <div className="flex items-start gap-3">
//                 <span className="text-blue-500 mt-1">✓</span>
//                 <p>How path AI incorporates feedback to continuously refine its investigative process and accuracy.</p>
//               </div>
//             </div>
//           </div>
//         </div>
...
export default function RequestDemo() {
  return (
    <>
      ...
      {/* Right Side */}
      <div
        className="relative hidden md:block md:w-1/2 bg-slate-950"
        aria-hidden="true"
      >
        <div className="min-h-screen h-full flex flex-col justify-center px-6 sm:px-10">
          <div className="max-w-lg mx-auto text-slate-100 space-y-8">
            <h2 className="text-3xl md:text-4xl font-bold font-playfair-display">
              Request a demo
            </h2>
            <p className="text-slate-100">
              Fill out the form to schedule a personalized demo that shows you
              how Innovapath Agentic AI SOC Analyst transforms alert triage and
              investigation.
            </p>
            <p className="text-slate-200">During your demo, you’ll see:</p>
            <div className="space-y-4 text-slate-300">
              <div className="flex items-start gap-3">
                <span className="text-blue-500 mt-1">✓</span>
                <p>
                  A step-by-step walkthrough of how Innovapath AI investigates
                  alerts.
                </p>
              </div>
              <div className="flex items-start gap-3">
                <span className="text-blue-500 mt-1">✓</span>
                <p>
                  How Innovapath AI integrates into your environment with an
                  easy 3-step API setup to drive rapid time-to-value.
                </p>
              </div>
              <div className="flex items-start gap-3">
                <span className="text-blue-500 mt-1">✓</span>
                <p>
                  A demonstration of its explainable AI framework that
              ...
              <div className="flex items-start gap-3">
                <span className="text-blue-500 mt-1">✓</span>
                <p>
                  How Innovapath AI incorporates feedback to continuously refine
                  its investigative process and accuracy.
                </p>
              </div>
            </div>
          </div>
