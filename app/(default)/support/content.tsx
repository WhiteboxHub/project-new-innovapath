                ...
                <div className="grow">
                  <header>
                    <h2 className="h4 font-playfair-display mb-2">
                      <a className="text-slate-800 hover:underline hover:decoration-blue-100" href="#0">Getting Started with Innovapath</a>
                    </h2>
                  </header>
                  <p className="text-slate-500 mb-4">New to Innovapath or feeling a little lost? Start here ;)</p>
            ...
            <article className="bg-white p-6 md:px-8 shadow-lg" data-aos="fade-up" data-aos-anchor="[data-aos-id-support]" data-aos-delay={300}>
              <div className="flex">
                ...
                <div className="grow">
                  ...
                  <p className="text-slate-500 mb-4">Find the most commonly asked questions about Innovapath's API</p>
                  <footer className="flex items-center">
                    <div className="flex shrink-0 -space-x-3 -ml-0.5 mr-3">
                      <Image className="rounded-full border-2 border-white box-content" src={AvatarImage01} width={32} height={32} alt="Avatar 01" />
                    </div>
